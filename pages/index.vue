<template>
  <div class="mosaic-bg min-h-screen flex flex-col items-center justify-between bg-transparent shadow-inner relative bg-white">
    ...
    <div class="relative isolate h-full">
      ...
      <div class="overflow-hidden">
        <div class="mx-auto max-w-8xl md:w-full">
          <div class="mx-auto max-w-2xl gap-x-10 md:gap-x-12 lg:gap-x-24 lg:mx-0 lg:flex lg:max-w-none lg:items-center pt-10">
            <div class="w-full max-w-xl lg:shrink-0 lg:pr-0 xl:max-w-2xl pl-20 pr-24 xs:pl-12 xl2:pl-0">
              <h1 class="text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl">We’re changing the way people connect.</h1>
