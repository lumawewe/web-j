      ...
      <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
        <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
          <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Transformando ideias em realidade digital.</h1>
            <p class="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">Na Agência Mav, nós acreditamos no poder da tecnologia para transformar ideias em soluções digitais inovadoras. Seja um site, um aplicativo ou um jogo, nossa equipe de especialistas está pronta para ajudar você a trazer sua visão para a vida digital.</p>
          </div>
